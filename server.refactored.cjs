...
// === LTI 1.3 (ltijs) provider setup - UITGESCHAKELD ===
// LTI is tijdelijk uitgeschakeld om MongoDB connectie problemen te voorkomen

// Initialiseer Express app
const app = express();

// LTI deployment removed - backend now runs without LTI
